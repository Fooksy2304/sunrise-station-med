...
{
    // Sunrise-Edit
    public static readonly ResPath DefaultEffectsPath = new("/Textures/Objects/Weapons/Effects");

    // Sunrise-Edit
    public static readonly SpriteSpecifier.Rsi DefaultEffect = new(DefaultEffectsPath, "shield2");
